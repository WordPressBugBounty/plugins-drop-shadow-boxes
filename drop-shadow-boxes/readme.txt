...
I'm offering this plugin free of charge. If you use it and like it [please consider giving it a rating](https://wordpress.org/support/plugin/drop-shadow-boxes/reviews/).
...
1. The block for the new editor (Gutenberg)
2. Shortcode builder (Classic Editor)
3. Widget options
4. Example boxes
...
= 1.7.3 =
1. Fixed an issue where the height of the box doesn't stretch to accommodate images that are left aligned inside the box.
1. Updated the Freemius API.

= 1.7.2 =
1. Fixed security issue.

= 1.7.1 =
1. Fixed missing colour settings in the new WordPress editor.

= 1.7 =
1. Fixed support for the new editor.

= 1.6 =
1. Added support for Gutenberg, the new editor.

= 1.5.8 =
1. Fixed an issue where a top level menu item may appear.

= 1.5.7 =
1. Added opt-in feedback system.
1. Updated version WordPress "Tested up to" and copyright notice.

= 1.5.6 =
1. Fixed a JavaScript error in the customizer.

= 1.5.5 =
1. Updated version WordPress "Tested up to".
1. Fixed some coding standards.
...
= 1.7 =
1. Fixed support for the new editor (Gutenberg).
